...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){let e=new Worker(this.workerSourceURL);e._callbacks={},e._taskCosts={},e._taskLoad=0,e.postMessage({type:`init`,decoderConfig:this.decoderConfig}),e.onmessage=function(t){let n=t.data;switch(n.type){case`decode`:e._callbacks[n.id].resolve(n);break;case`error`:e._callbacks[n.id].reject(n);break;default:console.error(`THREE.DRACOLoader: Unexpected message, "`+n.type+`"`)}},this.workerPool.push(e)}else this.workerPool.sort(function(e,t){return e._taskLoad>t._taskLoad?-1:1});let n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log(`Task load: `,this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==``&&URL.revokeObjectURL(this.workerSourceURL),this}};function Vd(){let e,t;onmessage=function(r){let i=r.data;switch(i.type){case`init`:e=i.decoderConfig,t=new Promise(function(t){e.onModuleLoaded=function(e){t({draco:e})},DracoDecoderModule(e)});break;case`decode`:let r=i.buffer,a=i.taskConfig;t.then(e=>{let t=e.draco,o=new t.Decoder;try{let e=n(t,o,new Int8Array(r),a),s=e.attributes.map(e=>e.array.buffer);e.index&&s.push(e.index.array.buffer),self.postMessage({type:`decode`,id:i.id,geometry:e},s)}catch(e){console.error(e),self.postMessage({type:`error`,id:i.id,error:e.message})}finally{t.destroy(o)}})}};function n(e,t,n,a){let o=a.attributeIDs,s=a.attributeTypes,c,l,u=t.GetEncodedGeometryType(n);if(u===e.TRIANGULAR_MESH)c=new e.Mesh,l=t.DecodeArrayToMesh(n,n.byteLength,c);else if(u===e.POINT_CLOUD)c=new e.PointCloud,l=t.DecodeArrayToPointCloud(n,n.byteLength,c);else throw Error(`THREE.DRACOLoader: Unexpected geometry type.`);if(!l.ok()||c.ptr===0)throw Error(`THREE.DRACOLoader: Decoding failed: `+l.error_msg());let d={index:null,attributes:[]};for(let n in o){let r=self[s[n]],l,u;if(a.useUniqueIDs)u=o[n],l=t.GetAttributeByUniqueId(c,u);else{if(u=t.GetAttributeId(c,e[o[n]]),u===-1)continue;l=t.GetAttribute(c,u)}let f=i(e,t,c,n,r,l);n===`color`&&(f.vertexColorSpace=a.vertexColorSpace),d.attributes.push(f)}return u===e.TRIANGULAR_MESH&&(d.index=r(e,t,c)),e.destroy(c),d}function r(e,t,n){let r=n.num_faces()*3,i=r*4,a=e._malloc(i);t.GetTrianglesUInt32Array(n,i,a);let o=new Uint32Array(e.HEAPF32.buffer,a,r).slice();return e._free(a),{array:o,itemSize:1}}function i(e,t,n,r,i,o){let s=n.num_points(),c=o.num_components(),l=a(e,i),u=c*i.BYTES_PER_ELEMENT,d=Math.ceil(u/4)*4,f=d/i.BYTES_PER_ELEMENT,p=s*u,m=s*d,h=e._malloc(p);t.GetAttributeDataArrayForAllPoints(n,o,l,p,h);let g=new i(e.HEAPF32.buffer,h,p/i.BYTES_PER_ELEMENT),_;if(u===d)_=g.slice();else{_=new i(m/i.BYTES_PER_ELEMENT);let e=0;for(let t=0,n=g.length;t<n;t++){for(let n=0;n<c;n++)_[e+n]=g[t*c+n];e+=f}}return e._free(h),{name:r,count:s,itemSize:c,array:_,stride:f}}function a(e,t){switch(t){case Float32Array:return e.DT_FLOAT32;case Int8Array:return e.DT_INT8;case Int16Array:return e.DT_INT16;case Int32Array:return e.DT_INT32;case Uint8Array:return e.DT_UINT8;case Uint16Array:return e.DT_UINT16;case Uint32Array:return e.DT_UINT32}}}function Hd(e,t){return e.getInterpolation()===t.getInterpolation()&&e.times.length===t.times.length&&e.values.length===t.values.length&&e.times.every((e,n)=>e===t.times[n])&&e.values.every((e,n)=>e===t.values[n])}function Ud(e){if(e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline)return!1;let t=e.getValueSize();return e.values.every((n,r)=>Math.abs(n-e.values[r%t])<1e-7)}function Wd(e,t){let n=new Map,r=[];for(let e of t)for(let t of e.tracks){let i=n.get(t.name);if(!i)n.set(t.name,{clip:e,track:t});else if(Hd(i.track,t))r.push({property:t.name,discarded:e.name,reason:`identical`});else if(Ud(i.track)!==Ud(t)){let a=Ud(i.track);r.push({property:t.name,discarded:a?i.clip.name:e.name,reason:`static duplicate`}),a&&n.set(t.name,{clip:e,track:t})}else throw Error(`Animation export conflict: ${t.name} is controlled differently by ${i.clip.name} and ${e.name}`)}let i=new Wo(e),a=[];for(let e of t){let t=e.tracks.filter(t=>{let r=n.get(t.name);return r?.clip===e&&r.track===t});if(!t.length)continue;let r=new Va(e.name,e.duration,t,e.blendMode),o=i.clipAction(r);o.setLoop(F,1/0).setEffectiveWeight(1).setEffectiveTimeScale(1).play(),a.push(o)}return i.update(0),{mixer:i,actions:a,diagnostics:{sourceClips:t.length,playingClips:a.length,tracks:n.size,duplicates:r},dispose(){i.stopAllAction();for(let e of a)i.uncacheClip(e.getClip());i.uncacheRoot(e)}}}var Gd=e=>document.getElementById(e),$=Object.fromEntries([`stage`,`canvas`,`poster`,`load-status`,`load-title`,`load-detail`,`load-progress`,`retry`,`play`,`play-icon`,`play-label`,`front`,`head`,`compare`,`reference-panel`,`reference`,`reference-error`,`motion-note`].map(e=>[e,Gd(e)])),Kd=e=>`./assets/${e}${/\.(glb|png)$/.test(e)?`?v=c0b73bc78538`:``}`,qd=matchMedia(`(prefers-reduced-motion: reduce)`),Jd=new G(.13,.27,0),Yd={shrimp:{label:`虾虾`,name:`Doro 虾虾`,head:`Doro · 3D head`,model:`doro.glb`,poster:`poster.png`,note:`Doro 可爱，虾也可爱。`},dog:{label:`狗狗`,name:`Doro 狗狗`,head:`Doro · 3D head`,model:`doro-dog.glb`,poster:`poster-dog.png`,note:`同一颗小脑袋，换了四只小短腿。`},palico:{label:`蓝色呆猫`,name:`蓝色呆猫`,head:`Kit T head`,model:`palico.glb`,poster:`palico.png`,note:`圆脸、大耳朵，站好给你看看。`,static:!0},siamese:{label:`四足呆猫`,name:`四足呆猫`,head:`Kit T head`,model:`siamese.glb`,poster:`siamese.png`,note:`呆猫的脑袋，配上四只小猫腿。`,static:!0}},Xd=new In,Zd=new yo(-2.8,2.8,2.8,-2.8,.01,100);Zd.up.set(0,1,0),Zd.position.set(.13,.27,12);var Qd=new to(16777215,14802390,2);Xd.add(Qd);var $d=new xo(16777215,2.2);$d.position.set(-3,5,8),Xd.add($d);var ef=new xo(16777215,0);ef.position.set(4,3,5);var tf=new xo(16777215,0);tf.position.set(-1,5,-4),Xd.add(ef,tf);var nf,rf,af,of,sf,cf,lf=!qd.matches,uf=!1,df=5.6,ff=0,pf=`shrimp`,mf={},hf=12,gf=!0,_f=performance.now(),vf,yf=!1,bf=0,xf=null,Sf=innerWidth>=980&&!qd.matches;window.doroViewer={state:`loading`,mode:pf,animation:null,headFound:!1},$.poster.addEventListener(`load`,()=>{$.poster.currentSrc===new URL(Kd(Yd[pf].poster),location.href).href&&(af||($.poster.hidden=!1),$.stage.classList.add(`has-poster`),window.doroViewer.state===`error`&&($[`load-detail`].textContent=`先看看预览图，也可以重新加载。`))}),$.poster.addEventListener(`error`,()=>{$.poster.hidden=!0,$.stage.classList.remove(`has-poster`)}),$.reference.addEventListener(`error`,()=>{$.reference.hidden=!0,$[`reference-error`].hidden=!1});function Cf(e){$[`reference-panel`].hidden=!e,document.querySelector(`.exhibit`).classList.toggle(`is-comparing`,e),$.compare.setAttribute(`aria-expanded`,String(e)),$.compare.querySelector(`.compare-mark`).textContent=e?`−`:`＋`,e&&!yf&&(yf=!0,$.reference.src=Kd(`reference.gif`))}$.compare.addEventListener(`click`,()=>{Sf=$[`reference-panel`].hidden,Cf(Sf)}),Cf(Sf);function wf(){if(Yd[pf].static){$[`play-label`].textContent=`静态`,$.play.setAttribute(`aria-label`,`静态模型`),$[`play-icon`].innerHTML=`<path d="M4 4h8v8H4Z" />`;return}$[`play-label`].textContent=lf?`暂停`:`播放`,$.play.setAttribute(`aria-label`,lf?`暂停动画`:`播放动画`),$[`play-icon`].innerHTML=lf?`<path d="M5 3v10M11 3v10" />`:`<path d="m5 3 8 5-8 5Z" />`}wf(),qd.matches&&($[`motion-note`].textContent=`已按系统偏好暂停，可随时点播放。`),$.play.addEventListener(`click`,()=>{lf=!lf,_f=performance.now(),wf(),$[`motion-note`].textContent=lf?Yd[pf].note:`停一会儿，转着看看。`}),qd.addEventListener(`change`,e=>{e.matches&&(lf=!1,wf(),Cf(!1),$[`motion-note`].textContent=Yd[pf].static?Yd[pf].note:`已按系统偏好暂停，可随时点播放。`)});function Tf(){let{width:e,height:t}=$.stage.getBoundingClientRect();if(!nf||e<1||t<1)return;let n=e/t,r=Math.max(df,ff/n)/2;Zd.left=-r*n,Zd.right=r*n,Zd.top=r,Zd.bottom=-r,Zd.updateProjectionMatrix(),nf.setPixelRatio(Math.min(devicePixelRatio||1,2)),nf.setSize(e,t,!1),gf=!0}function Ef(){rf.enableDamping=!1,rf.update(),rf.enableDamping=!qd.matches}function Df(e=!1,t=!1){if(!af)return;af.updateWorldMatrix(!0,!0);let n=new Zn().setFromObject(uf?of:af,!0);if(n.isEmpty())return;let r=Array.isArray(mf.center)&&mf.center.length===3&&mf.center.every(Number.isFinite)?new G(...mf.center):null,i=uf?n.getCenter(new G):r||(pf===`shrimp`?Jd.clone():n.getCenter(new G)),a=Zd.position.clone().sub(rf.target).normalize();if((e||t)&&(a=new G(0,0,1)),e&&pf===`dog`&&of&&a.transformDirection(of.matrixWorld),t&&!e&&Array.isArray(mf.cameraDirection)&&mf.cameraDirection.length===3&&mf.cameraDirection.every(Number.isFinite)){let e=new G(...mf.cameraDirection);e.lengthSq()>1e-8&&(a=e.normalize())}if(uf){let e=new G,t=new G(0,1,0).cross(a).normalize(),n=a.clone().cross(t).normalize(),r=0,o=0;of.traverse(a=>{if(!a.isMesh)return;let s=a.geometry.getAttribute(`position`);if(s)for(let c=0;c<s.count;c+=1)a.getVertexPosition(c,e).applyMatrix4(a.matrixWorld).sub(i),r=Math.max(r,Math.abs(e.dot(t))),o=Math.max(o,Math.abs(e.dot(n)))}),df=o*2*1.16,ff=r*2*1.16}else{let e=Number.isFinite(mf.orthoScale)&&mf.orthoScale>0?mf.orthoScale:pf===`shrimp`?5.6:0,t=new G(0,1,0).cross(a);t.lengthSq()<1e-8?t.set(1,0,0):t.normalize();let r=a.clone().cross(t).normalize(),o=0,s=0;for(let e of[n.min.x,n.max.x])for(let a of[n.min.y,n.max.y])for(let c of[n.min.z,n.max.z]){let n=new G(e,a,c).sub(i);o=Math.max(o,Math.abs(n.dot(t))),s=Math.max(s,Math.abs(n.dot(r)))}df=Math.max(e,2*s*1.16),ff=2*o*1.16}Ef(),rf.target.copy(i),Zd.position.copy(i).addScaledVector(a,hf),Zd.zoom=1,Zd.up.set(0,1,0),rf.update(),Tf()}$.front.addEventListener(`click`,()=>Df(!0)),$.head.addEventListener(`click`,()=>{uf=!uf,$.head.textContent=uf?`看整体`:`看头部`,$.head.setAttribute(`aria-pressed`,String(uf)),Df()});function Of(e){let t=Math.max(0,Math.min((e-_f)/1e3,.1));if(_f=e,document.hidden||!af)return;let n=rf.update();lf&&sf?.actions.length&&(sf.mixer.update(t),gf=!0),(gf||n)&&(nf.render(Xd,Zd),gf=!1)}document.addEventListener(`visibilitychange`,()=>{_f=performance.now(),nf&&nf.setAnimationLoop(document.hidden?null:Of),gf=!0});function kf(){let e=Yd[pf].static;nf.toneMapping=e?6:0,nf.toneMappingExposure=e?1.5:1,$d.intensity=e?4.5:2.2,Qd.intensity=e?1.2:2,ef.intensity=+!!e,tf.intensity=e?1.3:0,gf=!0}function Af(){nf=new uu({canvas:$.canvas,antialias:!0,alpha:!0}),nf.outputColorSpace=We,nf.toneMapping=0,nf.setClearColor(16447732,0),rf=new xu(Zd,$.canvas),rf.target.copy(Jd),rf.enablePan=!1,rf.enableDamping=!qd.matches,rf.dampingFactor=.09,rf.minZoom=.45,rf.maxZoom=4,rf.minPolarAngle=.02,rf.maxPolarAngle=Math.PI-.02,rf.rotateSpeed=.65,rf.zoomSpeed=.7,rf.addEventListener(`change`,()=>{gf=!0}),new ResizeObserver(Tf).observe($.stage),$.canvas.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),nf.setAnimationLoop(null),jf(Error(`WebGL context lost`)),$[`load-title`].textContent=`展示暂时停了一下`,$[`load-detail`].textContent=`重新加载就能再转着看。`,$.retry.onclick=()=>location.reload()}),$.canvas.addEventListener(`keydown`,e=>{if(!af||![`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`+`,`=`,`-`,`_`,`Home`].includes(e.key))return;if(e.preventDefault(),e.key===`Home`)return Df(!0);Ef();let t=Zd.position.clone().sub(rf.target),n=new Go().setFromVector3(t);e.key===`ArrowLeft`&&(n.theta-=.1),e.key===`ArrowRight`&&(n.theta+=.1),e.key===`ArrowUp`&&(n.phi-=.1),e.key===`ArrowDown`&&(n.phi+=.1),n.phi=jt.clamp(n.phi,.02,Math.PI-.02),[`+`,`=`].includes(e.key)&&(Zd.zoom=Math.min(rf.maxZoom,Zd.zoom*1.15)),[`-`,`_`].includes(e.key)&&(Zd.zoom=Math.max(rf.minZoom,Zd.zoom/1.15)),Zd.position.copy(rf.target).add(new G().setFromSpherical(n)),Zd.updateProjectionMatrix(),rf.update(),gf=!0}),Tf(),nf.setAnimationLoop(Of)}function jf(e){window.doroViewer.state=`error`,window.doroViewer.error=e.message,$.stage.setAttribute(`aria-busy`,`false`),$.canvas.hidden=!0,$.poster.hidden=!$.stage.classList.contains(`has-poster`),$[`load-status`].hidden=!1,$[`load-title`].textContent=`3D 暂时没加载出来`,$[`load-detail`].textContent=$.poster.hidden?`可以再试一次，或稍后回来看看。`:`先看看预览图，也可以重新加载。`,$[`load-progress`].hidden=!0,$.retry.hidden=!1,$.play.disabled=$.front.disabled=$.head.disabled=!0,console.error(`[Doro viewer]`,e)}async function Mf(e,t,n){let r=await fetch(Kd(Yd[e].model),{signal:t});if(!r.ok)throw Error(`Model request failed: HTTP ${r.status}`);let i=Number(r.headers.get(`content-length`)),a=r.body?.getReader();if(!a)return r.arrayBuffer();let o=[],s=0;for(;;){let{value:e,done:t}=await a.read();if(t)break;if(o.push(e),s+=e.byteLength,n===bf){if(i>0){let e=Math.min(s/i,1);$[`load-progress`].value=e,$[`load-detail`].textContent=`正在加载立体模型 · ${Math.round(e*100)}%`}else $[`load-detail`].textContent=`正在加载立体模型 · ${(s/1048576).toFixed(1)} MB`}}let c=new Uint8Array(s),l=0;for(let e of o)c.set(e,l),l+=e.byteLength;if(c.length<12||new DataView(c.buffer).getUint32(0,!0)!==1179937895)throw Error(`The model response is not a GLB file`);return c.buffer}function Nf(e){let t=new Set,n=new Set,r=new Set,i=new Set;e.traverse(e=>{e.geometry&&t.add(e.geometry),e.skeleton&&i.add(e.skeleton);for(let t of Array.isArray(e.material)?e.material:e.material?[e.material]:[])n.add(t)});for(let e of n)for(let t of Object.values(e))t?.isTexture&&r.add(t);for(let e of t)e.dispose();for(let e of n)e.dispose();let a=new Set;for(let e of r)e.source?.data&&a.add(e.source.data),e.dispose();for(let e of a)typeof e.close==`function`&&e.close();for(let e of i)e.dispose()}function Pf(){sf?.dispose(),sf=null,af&&(Xd.remove(af),Nf(af)),af=null,of=null,mf={},uf=!1,$.head.textContent=`看头部`,$.head.setAttribute(`aria-pressed`,`false`),nf?.renderLists.dispose()}async function Ff(){let e=pf,t=++bf;vf?.abort();let n=new AbortController;vf=n;let r=setTimeout(()=>n.abort(),12e4);Pf(),$.canvas.hidden=!0,$.play.disabled=$.front.disabled=$.head.disabled=!0,$.poster.hidden=!0,$.stage.classList.remove(`has-poster`),$.poster.alt=`${Yd[e].name}预览图`,$.poster.src=Kd(Yd[e].poster),$.canvas.setAttribute(`aria-label`,`可旋转的 ${Yd[e].name}三维模型`),$[`load-status`].hidden=!1,window.doroViewer={state:`loading`,mode:e,animation:null,headFound:!1},$.stage.setAttribute(`aria-busy`,`true`),$[`load-title`].textContent=`${Yd[e].name}正在过来…`,$[`load-detail`].textContent=`正在加载立体模型`,$[`load-progress`].hidden=!1,$[`load-progress`].removeAttribute(`value`),$.retry.hidden=!0;try{nf||Af(),kf(),wf();let r=await Mf(e,n.signal,t);if(xf&&await xf.catch(()=>{}),t!==bf)return;if(n.signal.aborted)throw Error(`Model load timed out`);$[`load-detail`].textContent=`快好啦…`;let i=new Lu;cf||(cf=new Bd,cf.setDecoderPath(new URL(Kd(`draco/`),location.href).href),cf.setWorkerLimit(2)),i.setDRACOLoader(cf);let a=i.parseAsync(r,new URL(Kd(``),location.href).href);xf=a;let o;try{o=await a}finally{xf===a&&(xf=null)}if(t!==bf||n.signal.aborted){if(Nf(o.scene),t===bf)throw Error(`Model load timed out`);return}let s;try{s=Wd(o.scene,o.animations)}catch(e){throw Nf(o.scene),e}af=o.scene,sf=s,mf=af.userData.viewer||{};let c=new Zn().setFromObject(af,!0).getBoundingSphere(new Sr).radius;hf=Number.isFinite(mf.cameraDistance)&&mf.cameraDistance>c?mf.cameraDistance:Math.max(12,c*4),Zd.far=Math.max(100,hf+c*8),af.traverse(t=>{(t.userData.name===Yd[e].head||t.name===Yd[e].head||t.name===Vo.sanitizeNodeName(Yd[e].head)||Yd[e].head===`Doro · 3D head`&&/doro.*3d[_\s·.-]*head/i.test(t.name))&&(of=t)}),Xd.add(af),Df(!1,!0),$.canvas.hidden=!1,$.poster.hidden=!0,$[`load-status`].hidden=!0,$.stage.setAttribute(`aria-busy`,`false`),$.play.disabled=!sf.actions.length,$.front.disabled=!1,$.head.disabled=!of,of||console.warn(`[Doro viewer] Head node not found; head focus disabled.`),window.doroViewer={state:`ready`,mode:e,animation:sf.diagnostics,headFound:!!of,inspect:()=>({playing:lf,time:sf?.mixer.time,focusingHead:uf,cameraPosition:Zd.position.toArray(),target:rf.target.toArray(),zoom:Zd.zoom,geometries:nf.info.memory.geometries,textures:nf.info.memory.textures})},gf=!0,_f=performance.now()}catch(e){t===bf&&jf(e)}finally{clearTimeout(r)}}$.retry.addEventListener(`click`,Ff);for(let e of document.querySelectorAll(`[data-mode]`))e.addEventListener(`click`,()=>{if(e.dataset.mode!==pf){pf=e.dataset.mode;for(let t of document.querySelectorAll(`[data-mode]`))t.setAttribute(`aria-pressed`,String(t===e));$.compare.hidden=pf!==`shrimp`,Cf(pf===`shrimp`&&Sf),$[`motion-note`].textContent=lf||Yd[pf].static?Yd[pf].note:qd.matches?`已按系统偏好暂停，可随时点播放。`:`停一会儿，转着看看。`,Ff()}});Ff();