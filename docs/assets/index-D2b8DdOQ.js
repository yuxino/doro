...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){let e=new Worker(this.workerSourceURL);e._callbacks={},e._taskCosts={},e._taskLoad=0,e.postMessage({type:`init`,decoderConfig:this.decoderConfig}),e.onmessage=function(t){let n=t.data;switch(n.type){case`decode`:e._callbacks[n.id].resolve(n);break;case`error`:e._callbacks[n.id].reject(n);break;default:console.error(`THREE.DRACOLoader: Unexpected message, "`+n.type+`"`)}},this.workerPool.push(e)}else this.workerPool.sort(function(e,t){return e._taskLoad>t._taskLoad?-1:1});let n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log(`Task load: `,this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==``&&URL.revokeObjectURL(this.workerSourceURL),this}};function Vd(){let e,t;onmessage=function(r){let i=r.data;switch(i.type){case`init`:e=i.decoderConfig,t=new Promise(function(t){e.onModuleLoaded=function(e){t({draco:e})},DracoDecoderModule(e)});break;case`decode`:let r=i.buffer,a=i.taskConfig;t.then(e=>{let t=e.draco,o=new t.Decoder;try{let e=n(t,o,new Int8Array(r),a),s=e.attributes.map(e=>e.array.buffer);e.index&&s.push(e.index.array.buffer),self.postMessage({type:`decode`,id:i.id,geometry:e},s)}catch(e){console.error(e),self.postMessage({type:`error`,id:i.id,error:e.message})}finally{t.destroy(o)}})}};function n(e,t,n,a){let o=a.attributeIDs,s=a.attributeTypes,c,l,u=t.GetEncodedGeometryType(n);if(u===e.TRIANGULAR_MESH)c=new e.Mesh,l=t.DecodeArrayToMesh(n,n.byteLength,c);else if(u===e.POINT_CLOUD)c=new e.PointCloud,l=t.DecodeArrayToPointCloud(n,n.byteLength,c);else throw Error(`THREE.DRACOLoader: Unexpected geometry type.`);if(!l.ok()||c.ptr===0)throw Error(`THREE.DRACOLoader: Decoding failed: `+l.error_msg());let d={index:null,attributes:[]};for(let n in o){let r=self[s[n]],l,u;if(a.useUniqueIDs)u=o[n],l=t.GetAttributeByUniqueId(c,u);else{if(u=t.GetAttributeId(c,e[o[n]]),u===-1)continue;l=t.GetAttribute(c,u)}let f=i(e,t,c,n,r,l);n===`color`&&(f.vertexColorSpace=a.vertexColorSpace),d.attributes.push(f)}return u===e.TRIANGULAR_MESH&&(d.index=r(e,t,c)),e.destroy(c),d}function r(e,t,n){let r=n.num_faces()*3,i=r*4,a=e._malloc(i);t.GetTrianglesUInt32Array(n,i,a);let o=new Uint32Array(e.HEAPF32.buffer,a,r).slice();return e._free(a),{array:o,itemSize:1}}function i(e,t,n,r,i,o){let s=n.num_points(),c=o.num_components(),l=a(e,i),u=c*i.BYTES_PER_ELEMENT,d=Math.ceil(u/4)*4,f=d/i.BYTES_PER_ELEMENT,p=s*u,m=s*d,h=e._malloc(p);t.GetAttributeDataArrayForAllPoints(n,o,l,p,h);let g=new i(e.HEAPF32.buffer,h,p/i.BYTES_PER_ELEMENT),_;if(u===d)_=g.slice();else{_=new i(m/i.BYTES_PER_ELEMENT);let e=0;for(let t=0,n=g.length;t<n;t++){for(let n=0;n<c;n++)_[e+n]=g[t*c+n];e+=f}}return e._free(h),{name:r,count:s,itemSize:c,array:_,stride:f}}function a(e,t){switch(t){case Float32Array:return e.DT_FLOAT32;case Int8Array:return e.DT_INT8;case Int16Array:return e.DT_INT16;case Int32Array:return e.DT_INT32;case Uint8Array:return e.DT_UINT8;case Uint16Array:return e.DT_UINT16;case Uint32Array:return e.DT_UINT32}}}function Hd(e,t){return e.getInterpolation()===t.getInterpolation()&&e.times.length===t.times.length&&e.values.length===t.values.length&&e.times.every((e,n)=>e===t.times[n])&&e.values.every((e,n)=>e===t.values[n])}function Ud(e){if(e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline)return!1;let t=e.getValueSize();return e.values.every((n,r)=>Math.abs(n-e.values[r%t])<1e-7)}function Wd(e,t){let n=new Map,r=[];for(let e of t)for(let t of e.tracks){let i=n.get(t.name);if(!i)n.set(t.name,{clip:e,track:t});else if(Hd(i.track,t))r.push({property:t.name,discarded:e.name,reason:`identical`});else if(Ud(i.track)!==Ud(t)){let a=Ud(i.track);r.push({property:t.name,discarded:a?i.clip.name:e.name,reason:`static duplicate`}),a&&n.set(t.name,{clip:e,track:t})}else throw Error(`Animation export conflict: ${t.name} is controlled differently by ${i.clip.name} and ${e.name}`)}let i=new Wo(e),a=[];for(let e of t){let t=e.tracks.filter(t=>{let r=n.get(t.name);return r?.clip===e&&r.track===t});if(!t.length)continue;let r=new Va(e.name,e.duration,t,e.blendMode),o=i.clipAction(r);o.setLoop(F,1/0).setEffectiveWeight(1).setEffectiveTimeScale(1).play(),a.push(o)}return i.update(0),{mixer:i,actions:a,diagnostics:{sourceClips:t.length,playingClips:a.length,tracks:n.size,duplicates:r},dispose(){i.stopAllAction();for(let e of a)i.uncacheClip(e.getClip());i.uncacheRoot(e)}}}var Gd=e=>document.getElementById(e),$=Object.fromEntries([`stage`,`canvas`,`poster`,`load-status`,`load-title`,`load-detail`,`load-progress`,`retry`,`play`,`play-icon`,`play-label`,`front`,`head`,`compare`,`reference-panel`,`reference`,`reference-error`,`motion-note`].map(e=>[e,Gd(e)])),Kd=e=>`./assets/${e}${/\.(glb|png)$/.test(e)?`?v=01590b038c32`:``}`,qd=matchMedia(`(prefers-reduced-motion: reduce)`),Jd=new G(.13,.27,0),Yd={shrimp:{label:`虾虾`,model:`doro.glb`,poster:`poster.png`,note:`Doro 可爱，虾也可爱。`},dog:{label:`狗狗`,model:`doro-dog.glb`,poster:`poster-dog.png`,note:`同一颗小脑袋，换了四只小短腿。`}},Xd=new In,Zd=new yo(-2.8,2.8,2.8,-2.8,.01,100);Zd.up.set(0,1,0),Zd.position.set(.13,.27,12),Xd.add(new to(16777215,14802390,2));var Qd=new xo(16777215,2.2);Qd.position.set(-3,5,8),Xd.add(Qd);var $d,ef,tf,nf,rf,af,of=!qd.matches,sf=!1,cf=5.6,lf=0,uf=`shrimp`,df={},ff=12,pf=!0,mf=performance.now(),hf,gf=!1,_f=0,vf=null,yf=innerWidth>=980&&!qd.matches;window.doroViewer={state:`loading`,mode:uf,animation:null,headFound:!1},$.poster.addEventListener(`load`,()=>{$.poster.currentSrc===new URL(Kd(Yd[uf].poster),location.href).href&&(tf||($.poster.hidden=!1),$.stage.classList.add(`has-poster`),window.doroViewer.state===`error`&&($[`load-detail`].textContent=`先看看预览图，也可以重新加载。`))}),$.poster.addEventListener(`error`,()=>{$.poster.hidden=!0,$.stage.classList.remove(`has-poster`)}),$.reference.addEventListener(`error`,()=>{$.reference.hidden=!0,$[`reference-error`].hidden=!1});function bf(e){$[`reference-panel`].hidden=!e,document.querySelector(`.exhibit`).classList.toggle(`is-comparing`,e),$.compare.setAttribute(`aria-expanded`,String(e)),$.compare.querySelector(`.compare-mark`).textContent=e?`−`:`＋`,e&&!gf&&(gf=!0,$.reference.src=Kd(`reference.gif`))}$.compare.addEventListener(`click`,()=>{yf=$[`reference-panel`].hidden,bf(yf)}),bf(yf);function xf(){$[`play-label`].textContent=of?`暂停`:`播放`,$.play.setAttribute(`aria-label`,of?`暂停动画`:`播放动画`),$[`play-icon`].innerHTML=of?`<path d="M5 3v10M11 3v10" />`:`<path d="m5 3 8 5-8 5Z" />`}xf(),qd.matches&&($[`motion-note`].textContent=`已按系统偏好暂停，可随时点播放。`),$.play.addEventListener(`click`,()=>{of=!of,mf=performance.now(),xf(),$[`motion-note`].textContent=of?Yd[uf].note:`停一会儿，转着看看。`}),qd.addEventListener(`change`,e=>{e.matches&&(of=!1,xf(),bf(!1),$[`motion-note`].textContent=`已按系统偏好暂停，可随时点播放。`)});function Sf(){let{width:e,height:t}=$.stage.getBoundingClientRect();if(!$d||e<1||t<1)return;let n=e/t,r=Math.max(cf,lf/n)/2;Zd.left=-r*n,Zd.right=r*n,Zd.top=r,Zd.bottom=-r,Zd.updateProjectionMatrix(),$d.setPixelRatio(Math.min(devicePixelRatio||1,2)),$d.setSize(e,t,!1),pf=!0}function Cf(){ef.enableDamping=!1,ef.update(),ef.enableDamping=!qd.matches}function wf(e=!1,t=!1){if(!tf)return;tf.updateWorldMatrix(!0,!0);let n=new Zn().setFromObject(sf?nf:tf,!0);if(n.isEmpty())return;let r=Array.isArray(df.center)&&df.center.length===3&&df.center.every(Number.isFinite)?new G(...df.center):null,i=sf?n.getCenter(new G):r||(uf===`shrimp`?Jd.clone():n.getCenter(new G)),a=Zd.position.clone().sub(ef.target).normalize();if((e||t)&&(a=new G(0,0,1)),e&&uf===`dog`&&nf&&a.transformDirection(nf.matrixWorld),t&&!e&&Array.isArray(df.cameraDirection)&&df.cameraDirection.length===3&&df.cameraDirection.every(Number.isFinite)){let e=new G(...df.cameraDirection);e.lengthSq()>1e-8&&(a=e.normalize())}if(sf){let e=new G,t=new G(0,1,0).cross(a).normalize(),n=a.clone().cross(t).normalize(),r=0,o=0;nf.traverse(a=>{if(!a.isMesh)return;let s=a.geometry.getAttribute(`position`);if(s)for(let c=0;c<s.count;c+=1)a.getVertexPosition(c,e).applyMatrix4(a.matrixWorld).sub(i),r=Math.max(r,Math.abs(e.dot(t))),o=Math.max(o,Math.abs(e.dot(n)))}),cf=o*2*1.16,lf=r*2*1.16}else{let e=Number.isFinite(df.orthoScale)&&df.orthoScale>0?df.orthoScale:uf===`shrimp`?5.6:0,t=new G(0,1,0).cross(a);t.lengthSq()<1e-8?t.set(1,0,0):t.normalize();let r=a.clone().cross(t).normalize(),o=0,s=0;for(let e of[n.min.x,n.max.x])for(let a of[n.min.y,n.max.y])for(let c of[n.min.z,n.max.z]){let n=new G(e,a,c).sub(i);o=Math.max(o,Math.abs(n.dot(t))),s=Math.max(s,Math.abs(n.dot(r)))}cf=Math.max(e,2*s*1.16),lf=2*o*1.16}Cf(),ef.target.copy(i),Zd.position.copy(i).addScaledVector(a,ff),Zd.zoom=1,Zd.up.set(0,1,0),ef.update(),Sf()}$.front.addEventListener(`click`,()=>wf(!0)),$.head.addEventListener(`click`,()=>{sf=!sf,$.head.textContent=sf?`看整体`:`看头部`,$.head.setAttribute(`aria-pressed`,String(sf)),wf()});function Tf(e){let t=Math.max(0,Math.min((e-mf)/1e3,.1));if(mf=e,document.hidden||!tf)return;let n=ef.update();of&&rf?.actions.length&&(rf.mixer.update(t),pf=!0),(pf||n)&&($d.render(Xd,Zd),pf=!1)}document.addEventListener(`visibilitychange`,()=>{mf=performance.now(),$d&&$d.setAnimationLoop(document.hidden?null:Tf),pf=!0});function Ef(){$d=new uu({canvas:$.canvas,antialias:!0,alpha:!0}),$d.outputColorSpace=We,$d.toneMapping=0,$d.setClearColor(16447732,0),ef=new xu(Zd,$.canvas),ef.target.copy(Jd),ef.enablePan=!1,ef.enableDamping=!qd.matches,ef.dampingFactor=.09,ef.minZoom=.45,ef.maxZoom=4,ef.minPolarAngle=.02,ef.maxPolarAngle=Math.PI-.02,ef.rotateSpeed=.65,ef.zoomSpeed=.7,ef.addEventListener(`change`,()=>{pf=!0}),new ResizeObserver(Sf).observe($.stage),$.canvas.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),$d.setAnimationLoop(null),Df(Error(`WebGL context lost`)),$[`load-title`].textContent=`展示暂时停了一下`,$[`load-detail`].textContent=`重新加载就能再转着看。`,$.retry.onclick=()=>location.reload()}),$.canvas.addEventListener(`keydown`,e=>{if(!tf||![`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`+`,`=`,`-`,`_`,`Home`].includes(e.key))return;if(e.preventDefault(),e.key===`Home`)return wf(!0);Cf();let t=Zd.position.clone().sub(ef.target),n=new Go().setFromVector3(t);e.key===`ArrowLeft`&&(n.theta-=.1),e.key===`ArrowRight`&&(n.theta+=.1),e.key===`ArrowUp`&&(n.phi-=.1),e.key===`ArrowDown`&&(n.phi+=.1),n.phi=jt.clamp(n.phi,.02,Math.PI-.02),[`+`,`=`].includes(e.key)&&(Zd.zoom=Math.min(ef.maxZoom,Zd.zoom*1.15)),[`-`,`_`].includes(e.key)&&(Zd.zoom=Math.max(ef.minZoom,Zd.zoom/1.15)),Zd.position.copy(ef.target).add(new G().setFromSpherical(n)),Zd.updateProjectionMatrix(),ef.update(),pf=!0}),Sf(),$d.setAnimationLoop(Tf)}function Df(e){window.doroViewer.state=`error`,window.doroViewer.error=e.message,$.stage.setAttribute(`aria-busy`,`false`),$.canvas.hidden=!0,$.poster.hidden=!$.stage.classList.contains(`has-poster`),$[`load-status`].hidden=!1,$[`load-title`].textContent=`3D 暂时没加载出来`,$[`load-detail`].textContent=$.poster.hidden?`可以再试一次，或稍后回来看看。`:`先看看预览图，也可以重新加载。`,$[`load-progress`].hidden=!0,$.retry.hidden=!1,$.play.disabled=$.front.disabled=$.head.disabled=!0,console.error(`[Doro viewer]`,e)}async function Of(e,t,n){let r=await fetch(Kd(Yd[e].model),{signal:t});if(!r.ok)throw Error(`Model request failed: HTTP ${r.status}`);let i=Number(r.headers.get(`content-length`)),a=r.body?.getReader();if(!a)return r.arrayBuffer();let o=[],s=0;for(;;){let{value:e,done:t}=await a.read();if(t)break;if(o.push(e),s+=e.byteLength,n===_f){if(i>0){let e=Math.min(s/i,1);$[`load-progress`].value=e,$[`load-detail`].textContent=`正在加载立体模型 · ${Math.round(e*100)}%`}else $[`load-detail`].textContent=`正在加载立体模型 · ${(s/1048576).toFixed(1)} MB`}}let c=new Uint8Array(s),l=0;for(let e of o)c.set(e,l),l+=e.byteLength;if(c.length<12||new DataView(c.buffer).getUint32(0,!0)!==1179937895)throw Error(`The model response is not a GLB file`);return c.buffer}function kf(e){let t=new Set,n=new Set,r=new Set,i=new Set;e.traverse(e=>{e.geometry&&t.add(e.geometry),e.skeleton&&i.add(e.skeleton);for(let t of Array.isArray(e.material)?e.material:e.material?[e.material]:[])n.add(t)});for(let e of n)for(let t of Object.values(e))t?.isTexture&&r.add(t);for(let e of t)e.dispose();for(let e of n)e.dispose();let a=new Set;for(let e of r)e.source?.data&&a.add(e.source.data),e.dispose();for(let e of a)typeof e.close==`function`&&e.close();for(let e of i)e.dispose()}function Af(){rf?.dispose(),rf=null,tf&&(Xd.remove(tf),kf(tf)),tf=null,nf=null,df={},sf=!1,$.head.textContent=`看头部`,$.head.setAttribute(`aria-pressed`,`false`),$d?.renderLists.dispose()}async function jf(){let e=uf,t=++_f;hf?.abort();let n=new AbortController;hf=n;let r=setTimeout(()=>n.abort(),12e4);Af(),$.canvas.hidden=!0,$.play.disabled=$.front.disabled=$.head.disabled=!0,$.poster.hidden=!0,$.stage.classList.remove(`has-poster`),$.poster.alt=`Doro ${Yd[e].label}预览图`,$.poster.src=Kd(Yd[e].poster),$.canvas.setAttribute(`aria-label`,`可旋转的 Doro ${Yd[e].label}三维模型`),$[`load-status`].hidden=!1,window.doroViewer={state:`loading`,mode:e,animation:null,headFound:!1},$.stage.setAttribute(`aria-busy`,`true`),$[`load-title`].textContent=`Doro 正在过来…`,$[`load-detail`].textContent=`正在加载立体模型`,$[`load-progress`].hidden=!1,$[`load-progress`].removeAttribute(`value`),$.retry.hidden=!0;try{$d||Ef();let r=await Of(e,n.signal,t);if(vf&&await vf.catch(()=>{}),t!==_f)return;if(n.signal.aborted)throw Error(`Model load timed out`);$[`load-detail`].textContent=`快好啦…`;let i=new Lu;af||(af=new Bd,af.setDecoderPath(new URL(Kd(`draco/`),location.href).href),af.setWorkerLimit(2)),i.setDRACOLoader(af);let a=i.parseAsync(r,new URL(Kd(``),location.href).href);vf=a;let o;try{o=await a}finally{vf===a&&(vf=null)}if(t!==_f||n.signal.aborted){if(kf(o.scene),t===_f)throw Error(`Model load timed out`);return}let s;try{s=Wd(o.scene,o.animations)}catch(e){throw kf(o.scene),e}tf=o.scene,rf=s,df=tf.userData.viewer||{};let c=new Zn().setFromObject(tf,!0).getBoundingSphere(new Sr).radius;ff=Number.isFinite(df.cameraDistance)&&df.cameraDistance>c?df.cameraDistance:Math.max(12,c*4),Zd.far=Math.max(100,ff+c*8),tf.traverse(e=>{(e.userData.name===`Doro · 3D head`||e.name===`Doro · 3D head`||/doro.*3d[_\s·.-]*head/i.test(e.name))&&(nf=e)}),Xd.add(tf),wf(!1,!0),$.canvas.hidden=!1,$.poster.hidden=!0,$[`load-status`].hidden=!0,$.stage.setAttribute(`aria-busy`,`false`),$.play.disabled=!rf.actions.length,$.front.disabled=!1,$.head.disabled=!nf,nf||console.warn(`[Doro viewer] Head node not found; head focus disabled.`),window.doroViewer={state:`ready`,mode:e,animation:rf.diagnostics,headFound:!!nf,inspect:()=>({playing:of,time:rf?.mixer.time,focusingHead:sf,cameraPosition:Zd.position.toArray(),target:ef.target.toArray(),zoom:Zd.zoom,geometries:$d.info.memory.geometries,textures:$d.info.memory.textures})},pf=!0,mf=performance.now()}catch(e){t===_f&&Df(e)}finally{clearTimeout(r)}}$.retry.addEventListener(`click`,jf);for(let e of document.querySelectorAll(`[data-mode]`))e.addEventListener(`click`,()=>{if(e.dataset.mode!==uf){uf=e.dataset.mode;for(let t of document.querySelectorAll(`[data-mode]`))t.setAttribute(`aria-pressed`,String(t===e));$.compare.hidden=uf!==`shrimp`,bf(uf===`shrimp`&&yf),$[`motion-note`].textContent=of?Yd[uf].note:qd.matches?`已按系统偏好暂停，可随时点播放。`:`停一会儿，转着看看。`,jf()}});jf();